...
import com.example.wifi.TabActivity.sitelist;

import java.util.ArrayList;

public class DeviceListAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<DeviceListData> arrayList;
    Button button;
    private TextView name,livetext,alarm1,alarm2,alarm3;
    ListView listView;
    public DeviceListAdapter(Context context, ArrayList<DeviceListData> arrayList) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        convertView = LayoutInflater.from(context).inflate(R.layout.listview4, parent, false);
